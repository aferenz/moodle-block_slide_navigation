 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class block_slide_navigation_edit_form extends block_edit_form {
    /**
    ...
    protected function specific_definition($mform) {
        ...
        $options = array(
            block_slide_navigation::TRIM_RIGHT => get_string('trimmoderight', $this->block->blockname),
            block_slide_navigation::TRIM_LEFT => get_string('trimmodeleft', $this->block->blockname),
            block_slide_navigation::TRIM_CENTER => get_string('trimmodecenter', $this->block->blockname)
        );
