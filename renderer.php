 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class block_slide_navigation_renderer extends plugin_renderer_base {
    /**
    ...
    public function navigation_tree(global_navigation $navigation, $expansionlimit, array $options = array()) {
        ...
        $content ="<script src='http://code.jquery.com/jquery-1.9.0.min.js'></script>
                    <script type='text/javascript' src='{$CFG->wwwroot}/blocks/slide_navigation/js/jquery.cookie.js'></script>
                    <script type='text/javascript' src='{$CFG->wwwroot}/blocks/slide_navigation/js/jquery.hoverIntent.minified.js'></script>
                    <script type='text/javascript' src='{$CFG->wwwroot}/blocks/slide_navigation/js/jquery.dcjqaccordion.2.7.js'></script>
        ...
        $content .= '<div class="graphite">';
        $content .= $this->navigation_node(array($navigation), array('class'=>'accordion', 'id' => 'accordion-1'), $expansionlimit, $options);
    ...
    protected function navigation_node($items, $attrs=array(), $expansionlimit=null, array $options = array(), $depth=1) {
        ...
        $courseformat = get_config('slide_navigation', 'courseformat');
        $currentcourse = get_config('slide_navigation', 'hidecourses');
